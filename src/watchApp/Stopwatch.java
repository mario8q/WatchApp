...
public class Stopwatch implements ActionListener, WatchComponent {
    
    JFrame frame = new JFrame();
    JButton startButton = new JButton("START");
    JButton resetButton = new JButton("RESET");
    JLabel timeLabel = new JLabel();
    int elapsedTime = 0; //Ajuste del cronometro
    int seconds = 0;
    int minutes = 0;
    int hours = 0;
    ...
    void reset() {
        timer.stop();
        elapsedTime = 0; //Ajuste del cronometro
        seconds = 0;
        minutes = 0;
        hours = 0;
        seconds_string = String.format("%02d", seconds);
